...
#            h = math.atan(  ((0.5*xpx)-centroidx)/(0.5*xpx) * math.tan(0.5*fovh)    )
            ...
            cv2.putText(frame, 'x={} ,y={},dep={:03.3f}m'.format(centroidx,centroidy,depth),(10,30),cv2.FONT_HERSHEY_COMPLEX,2,(0,255,255),2)
            cv2.putText(frame, 'x={:03.3f}m, y={:03.3f}m, r={:03.3f}m'.format(-x_in_mm,y_in_mm,d_prl),(10,100),cv2.FONT_HERSHEY_COMPLEX, 2, (0,255,255),2)
